...
import com.lens.wx.gzh.modules.wx.form.TemplateMsgBatchForm;
import com.lens.wx.gzh.modules.wx.service.MsgTemplateService;
import com.lens.wx.gzh.modules.wx.service.TemplateMsgLogService;
import com.lens.wx.gzh.modules.wx.service.TemplateMsgService;
import com.lens.wx.gzh.modules.wx.service.WxUserService;
...
public class TemplateMsgServiceImpl implements TemplateMsgService {
    ...
    public void sendTemplateMsg(WxMpTemplateMessage msg,String appid) {
        com.lens.wx.gzh.config.TaskExcutor.submit(() -> {
            String result;
            try {
