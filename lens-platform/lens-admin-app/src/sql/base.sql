...
-- ----------------------------
/*
INSERT INTO `oauth_client_details` VALUES ('youlai-mall-admin', NULL, '123456', 'all', 'password,refresh_token', NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `sys_group`  (
  ...
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '组名称',
...
-- ----------------------------
INSERT INTO `sys_group` VALUES (8, '研发组', 0, '0', 1, 'Lens', '17621590365', '67949049@qq.com', 1, 0, 'admin', '2020-09-23 11:32:05', 'admin', '2020-09-23 11:32:05');
INSERT INTO `sys_group` VALUES (9, '测试组', 0, '0', 1, 'Lens', '15123569856', '67949049@qq.com', 1, 0, 'admin', '2020-09-23 11:33:06', 'admin', '2020-09-23 11:33:06');
...
INSERT INTO `sys_menu` VALUES (6, '组织管理', 1, 'dept', 'admin/group', NULL, NULL, 1, 'tree', 0, 1, 1, 'admin', NULL, 'admin', NULL);
...
-- ----------------------------
INSERT INTO `sys_resource` VALUES (1, '系统管理', '/lens-admin/**', NULL, NULL, NULL, NULL);
INSERT INTO `sys_resource` VALUES (2, '菜单管理', '/lens-admin/menus/**', NULL, NULL, NULL, NULL);
INSERT INTO `sys_resource` VALUES (3, '用户管理', '/lens-admin/users/**', NULL, NULL, NULL, NULL);
INSERT INTO `sys_resource` VALUES (4, '组织管理', '/lens-admin/group/**', NULL, NULL, NULL, NULL);
INSERT INTO `sys_resource` VALUES (5, '字典管理', '/lens-admin/dictionaries/**', NULL, NULL, NULL, NULL);
INSERT INTO `sys_resource` VALUES (6, '角色管理', '/lens-admin/roles/**', NULL, NULL, NULL, NULL);
INSERT INTO `sys_resource` VALUES (7, '资源管理', '/lens-admin/resources/**', NULL, NULL, NULL, NULL);
