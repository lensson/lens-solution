...
class PostListResponseEntity {
  ...
  factory PostListResponseEntity.fromJson(Map<String, dynamic> json) =>
      PostListResponseEntity(
        ...
        models: List<ArticleItem>.from(json["models"] != null
            ? json["models"].map((x) => ArticleItem.fromJson(x))
            : []),
...
class ArticleItem {
  ...
  factory ArticleItem.fromJson(Map<String, dynamic> json) => ArticleItem(
        ...
        tagsList: json["tagsList"] != null
            ? List<Tag>.from(json["tagsList"].map((x) => Tag.fromJson(x)))
            : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "author": author,
        "tagsList": tagsList?.map((e) => e.toJson())?.toList() ?? [],
