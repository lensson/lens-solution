...
ArchiveListResult archiveListResultFromJson(String str) =>
    ArchiveListResult.fromJson(json.decode(str));

String archiveListResultToJson(ArchiveListResult data) =>
...
class ArchiveListResult {
  ...
  factory ArchiveListResult.fromJson(Map<String, dynamic> json) =>
      ArchiveListResult(
        success: json["success"],
        resultCode: json["resultCode"],
        message: json["message"],
        models: List<ArchiveModel>.from(
            json["models"].map((x) => ArchiveModel.fromJson(x))),
      );
...
class ArchiveModel {
  ...
  factory ArchiveModel.fromJson(Map<String, dynamic> json) => ArchiveModel(
        ...
        archivePosts: List<ArticleItem>.from(
            json["archivePosts"].map((x) => ArticleItem.fromJson(x))),
      );
