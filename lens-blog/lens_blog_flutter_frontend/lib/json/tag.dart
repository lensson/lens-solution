...
GetTagListResult getTagListResultFromJson(String str) =>
    GetTagListResult.fromJson(json.decode(str));

String getTagListResultToJson(GetTagListResult data) =>
...
class GetTagListResult {
  ...
  factory GetTagListResult.fromJson(Map<String, dynamic> json) =>
      GetTagListResult(
