...
import 'package:lens_blog_flutter_frontend/widgets/search_delegate_widget.dart';
import 'package:provider/provider.dart';

import 'package:lens_blog_flutter_frontend/apis/categoryAPI.dart';
...
import 'package:lens_blog_flutter_frontend/notifier/selected_category.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        if (isNotMobile) Container() else getSearchButton()
      ],
    );
  }
...
//    selectedCategory.setSelected(categoryList[0].id,categoryList[0].name);
    ...
    return Consumer<SelectedCategory>(builder: (context, sc, child) {
      return Container(
        child: Column(
