package com.lens.blog.utils.serverInfo;


import com.lens.blog.utils.Arith;
import com.lens.blog.utils.DateUtils;
...
public class ServerInfo {
     ...
     * CPU相关信息
     */
    private com.lens.blog.utils.serverInfo.Cpu cpu = new com.lens.blog.utils.serverInfo.Cpu();
     ...
     * 服务器相关信息
     */
    private com.lens.blog.utils.serverInfo.Sys sys = new com.lens.blog.utils.serverInfo.Sys();
    ...
    public com.lens.blog.utils.serverInfo.Cpu getCpu() {
        return cpu;
    }

    public void setCpu(com.lens.blog.utils.serverInfo.Cpu cpu) {
        this.cpu = cpu;
    }
    ...
    public com.lens.blog.utils.serverInfo.Sys getSys() {
        return sys;
    }

    public void setSys(com.lens.blog.utils.serverInfo.Sys sys) {
        this.sys = sys;
    }
