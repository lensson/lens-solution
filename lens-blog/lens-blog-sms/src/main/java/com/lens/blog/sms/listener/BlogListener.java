...
import com.lens.blog.common.feign.SearchFeignClient;
import com.lens.blog.sms.global.RedisConf;
import com.lens.blog.sms.global.SysConf;
...
public class BlogListener {
    ...
    @RabbitListener(queues = "lens.blog")
...
//                    searchFeignClient.updateSolrIndexByUid(uid);
                ...
                case SysConf.DELETE: {
                    log.info("lens-sms处理删除博客: uid:" + uid);
                    updateSearch(map);
