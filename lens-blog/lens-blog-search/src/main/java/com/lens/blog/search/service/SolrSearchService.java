...
//    }
    ...
    private Map<String, Object> searchList(String collection, String keywords, Integer currentPage, Integer pageSize) {
        ...
        // 返回总记录数
        map.put(com.lens.blog.xo.global.SysConf.TOTAL, page.getTotalElements());
        // 返回总页数
        map.put(com.lens.blog.xo.global.SysConf.TOTAL_PAGE, page.getTotalPages());
        // 返回当前页大小
        map.put(com.lens.blog.xo.global.SysConf.PAGE_SIZE, pageSize);
        // 返回当前页
        map.put(com.lens.blog.xo.global.SysConf.CURRENT_PAGE, currentPage);
