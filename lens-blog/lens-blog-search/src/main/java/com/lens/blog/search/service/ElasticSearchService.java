package com.lens.blog.search.service;//package com.lens.blog.search.service;
//
//import com.lens.blog.common.entity.Blog;
//import com.lens.blog.common.entity.Tag;
//import com.lens.blog.search.global.SysConf;
//import com.lens.blog.search.mapper.HighlightResultHelper;
//import com.lens.blog.search.pojo.ESBlogIndex;
//import com.lens.blog.search.repository.BlogRepository;
...
//
//        HighlightBuilder.Field titleField = new HighlightBuilder.Field(SysConf.TITLE).preTags("<span
//        style='color:red'>").postTags("</span>");
//        HighlightBuilder.Field summaryField = new HighlightBuilder.Field(SysConf.SUMMARY).preTags("<span
//        style='color:red'>").postTags("</span>");
