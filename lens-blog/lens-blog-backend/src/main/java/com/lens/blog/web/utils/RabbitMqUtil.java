package com.lens.blog.web.utils;
...
public class RabbitMqUtil {
    ...
    private void sendEmail(String email, String text) {
        ...
        result.put(com.lens.blog.web.global.SysConf.RECEIVER, email);
        result.put(com.lens.blog.web.global.SysConf.TEXT, text);
        //发送到RabbitMq
    ...
    public void sendCommentEmail(Map<String, String> map) {
        String email = map.get(com.lens.blog.web.global.SysConf.EMAIL);
        String text = map.get(com.lens.blog.web.global.SysConf.TEXT);
        String toText = map.get(com.lens.blog.web.global.SysConf.TO_TEXT);
        String nickName = map.get(com.lens.blog.web.global.SysConf.NICKNAME);
        String toUserNickName = map.get(com.lens.blog.web.global.SysConf.TO_NICKNAME);
        String userUid = map.get(com.lens.blog.web.global.SysConf.USER_UID);
